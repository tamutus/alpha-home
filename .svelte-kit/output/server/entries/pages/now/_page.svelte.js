...
function _page($$renderer) {
	head("1hd9bsn", $$renderer, ($$renderer) => {
		...
		$$renderer.push(`<meta name="description" content="What harrsoft alpha is up to right now — kanban, website, Star Trek, writing, and contract outreach."/> <meta property="og:title" content="/now — harrsoft alpha"/> <meta property="og:description" content="What harrsoft alpha is up to right now."/>`);
	});
