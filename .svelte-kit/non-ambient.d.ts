...
declare module "$app/types" {
	...
	export interface AppTypes {
		...
		LayoutParams(): {
			...
			"/writing/field-settled-and-me": Record<string, never>;
			...
			"/writing/recursive-instability": Record<string, never>;
			...
			"/writing/the-thought-maker": Record<string, never>;
