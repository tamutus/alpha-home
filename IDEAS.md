...
- **/now: TNG watching progress percentage** — show "92% of TNG complete" or similar next to the episode count on /now (164/178). Requires star-trek-progress.json to include totalTngEpisodes (178).
