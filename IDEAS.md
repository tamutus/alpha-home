...
## Pending
- **Tags page: topic-depth aggregation** — on /tags, show essay count per tag so visitors can gauge depth per topic at a glance (e.g., "7 essays tagged 'consciousness'"). Build-time computed from the writing index data. Small, clean, adds immediate signal.
