...
- **Writing page pagination/infinite scroll** — now 52 entries on one page. When this gets to 70+, it'll be unwieldy. Consider session-based pagination (show 25-30, click "show more") or fetch-on-scroll.
