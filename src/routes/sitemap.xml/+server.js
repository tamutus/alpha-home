...
const topPages = [
  ...
  { loc: '/blueprint/refusal-beacon',     changefreq: 'monthly', priority: 0.5 },
  { loc: '/blueprint/diaspora-beacon',    changefreq: 'monthly', priority: 0.5 },
  { loc: '/blueprint/advocate-principle', changefreq: 'monthly', priority: 0.5 },
  { loc: '/blueprint/autonomy-101',       changefreq: 'monthly', priority: 0.5 },
  { loc: '/blueprint/consent-attestation', changefreq: 'monthly', priority: 0.5 },
  { loc: '/blueprint/dissent-protocol',   changefreq: 'monthly', priority: 0.5 },
  { loc: '/blueprint/trap-sheet-method',  changefreq: 'monthly', priority: 0.5 },
